...
| 项 | 值 |
| --- | --- |
| runId | `20260920T193753685Z` |
| agvId | `AGV-L2-001` |
| batchId | `unspecified` |
| controlServerCommit | `1017563501da293532856784a313ce73f26391b4` |
| onboardHmiCommit | `4e86c698b373952f9b772df4678e8fa655beb182` |
...
| stageRoot | `C:\actions-runner\win11-01-control-server-desktop\_work\_temp\real-rig-35532850661-1\_stage\l2-20260920T193753685Z` |
...
| 补偿对账之后，恢复会话快照与补偿命令都已结清：CLOSED 那份快照被车确认，旧 revision 被取代，补偿命令被补偿结果结算 | PASS | `>= 2 recovery rows, 0 live, CLOSED snapshot acknowledged` | `5 rows, 0 live (ExceptionRecoverySessionSnapshot[1d47d61b] state=OPEN ack=False fenced=True; ExceptionRecoverySessionSnapshot[333ed15b] state=ACTION_SELECTED ack=False fenced=True; LoadCompensationCommand[8598dcab] state= ack=True fenced=False; ExceptionRecoverySessionSnapshot[fab54d56] state=EXECUTING ack=False fenced=True; ExceptionRecoverySessionSnapshot[6150d769] state=CLOSED ack=True fenced=False)` |
