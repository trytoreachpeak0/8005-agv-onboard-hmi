...
| 项 | 值 |
| --- | --- |
| runId | `20260919T115440295Z` |
| agvId | `AGV-L2-001` |
| batchId | `batch-2` |
| controlServerCommit | `905ffd1dc0b4de1f048163342b45e58f3a7261fc` |
| onboardHmiCommit | `172077a742825ba603b81d3b027bd85a3b22bb89` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T115440295Z` |
...
| 补偿对账之后，恢复会话快照与补偿命令都已结清：CLOSED 那份快照被车确认，旧 revision 被取代，补偿命令被补偿结果结算 | PASS | `>= 2 recovery rows, 0 live, CLOSED snapshot acknowledged` | `5 rows, 0 live (ExceptionRecoverySessionSnapshot[065243ce] state=OPEN ack=False fenced=True; ExceptionRecoverySessionSnapshot[2935ed79] state=ACTION_SELECTED ack=False fenced=True; LoadCompensationCommand[ae79fb96] state= ack=True fenced=False; ExceptionRecoverySessionSnapshot[a966eedd] state=EXECUTING ack=False fenced=True; ExceptionRecoverySessionSnapshot[3ae9b87c] state=CLOSED ack=True fenced=False)` |
