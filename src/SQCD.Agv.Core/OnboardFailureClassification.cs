...
/// <c>RECOVERY_OPERATION_CONTEXT_MISSING</c> is thrown from eight sites as four different exception
...
/// </para>
/// <para>
/// <b>Both registries are total, and both are guarded at the source level</b> by
