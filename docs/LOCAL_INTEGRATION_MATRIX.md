...
| IS-03 | ControlServer HTTPS 车辆安全 projection provider；STOPPED/MOVING/UNKNOWN/MT_NA/过期、HTTP/TLS/认证/超时/格式/身份错误；未知快照零 IO；安全策略 fail-closed | 本机通过（Provider Unit 16 项、配置门禁 2 项） | ControlServer HTTPS 启用、正式证书/凭据配置、真实停稳/驻车信号接线和现场时效 |
